...
<div class="container-fluid">
  <div class="row pt-4">
	<div class="col-lg-12">
	  <h3><span data-i18n="memory.reporttitle_ram"></span> <span id="total-count" class='badge badge-primary'>…</span></h3>
	...
	$(document).on('appReady', function(e, lang) {
		...
		oTable = $('.table').dataTable( {
			...
			createdRow: function( nRow, aData, iDataIndex ) {
				...
				var link = mr.getClientDetailLink(name, sn, '#tab_ram-tab');
