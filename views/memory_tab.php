                ...
                for (var prop in d){
                    ...
                    if(skipThese.indexOf(prop) == -1){
                        ...
                        if(d[prop] == '' || d[prop] == null){
                            ...
                            if (d[prop] >= 80){
                                inforows = inforows + '<tr><th>'+i18n.t('memory.'+prop)+"</th><td><span class='badge alert-danger'>"+d[prop]+'% </span></td></tr>';
                               $('#memory-cnt').text(d[prop]+"%").addClass('alert-danger');
                            } else {
                                inforows = inforows + '<tr><th>'+i18n.t('memory.'+prop)+'</th><td>'+d[prop]+'% </td></tr>';
                               $('#memory-cnt').text(d[prop]+"%");
                            }
